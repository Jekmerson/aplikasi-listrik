-- Import this schema into MySQL via Laragon HeidiSQL or command line
--mysql -u root -p aplikasi_listrik_pascabayar < database_schema.sql
...
-- Insert User (Password MD5 untuk demo)
...
('PEL001', 'Ahmad Subarjo', 'Jl. Merdeka No. 123, Jakarta Pusat', '081234567890', 'ahmad@email.com', 2, 3, '2025-01-15', 'Aktif'),
('PEL002', 'Rina Melati', 'Jl. Sudirman No. 45, Jakarta Selatan', '081298765432', 'rina@email.com', 2, 4, '2025-02-20', 'Aktif'),
('PEL003', 'Joko Widodo', 'Jl. Gatot Subroto No. 78, Jakarta Barat', '081356789012', 'joko@email.com', 3, 5, '2025-01-10', 'Aktif'),
